...
const GLOBAL_CONFIG_PATH = path.join(os.homedir(), '.overseer.config.json');
...
function getOrInitOverseerGlobalConfig() {
...
export default defineConfig({
  plugins: [solidPlugin(), overseerApiPlugin()],
